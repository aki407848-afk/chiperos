...
void ui_clear();
void ui_draw_header(const String& title);
void ui_draw_footer(const String& hint);
void ui_draw_list(const String& items[], int count, int selectedIndex, int yOffset);
